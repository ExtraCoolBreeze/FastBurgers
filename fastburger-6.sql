...
--
-- Host: localhost:8889
-- Generation Time: May 28, 2024 at 09:10 AM
...
CREATE TABLE `Staff` (
  ...
  `shift` varchar(224) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Staff` (`staff_id`, `staff_firstname`, `staff_surname`, `staff_role`, `staff_tel`, `shift`) VALUES
(307, 'Name A', 'Surname A', 'Role A', '01700509899', 'day'),
(757, 'Name B', 'Surname B', 'Role B', '01700505050', 'night');
